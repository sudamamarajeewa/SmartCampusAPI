 ...
 *  - Logging can be added/removed/changed in one place without touching resources
 *  - Follows the Separation of Concerns principle
 *
 * @Provider — tells Jersey to auto-discover and register this filter via package scanning.
 */
@Provider
